...
/**
 *
 * We defined useCartHook as a function that returns an object with one field
 * 'products' from the useCartContext return type
 *
 *
 * ReturnType- constructs type from function return type. We can use ReturnType<()=>string>
 * to get string.
 *
 * Pick allows us to create a type with a subset of fields.
 * For example:
